...
#include<dune/parafields/io.hh>
#include<dune/parafields/randomfield.hh>
...
void printFullExample()
{
  std::cout << "# full example random field config file\n"
    ...
    << "#     whiteNoise\n"
    << "# or a custom class via \"custom-iso\" or \"custom-aniso\", the former\n"
    << "# is for isotropic custom covariances, the latter for general ones, and\n"
    << "# both require passing a custom class as template parameter to generate\n"
    << "covariance = exponential\n"
    << "# variance of random field\n"
    << "variance = 1.\n"
